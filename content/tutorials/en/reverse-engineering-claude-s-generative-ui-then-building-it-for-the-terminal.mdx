...
tags: ["OpenAI", "Claude", "RAG", "TypeScript", "Node.js", "Evaluation"]
techStack: []
difficulty: "Beginner"
duration: ""
...
So I went to claude.ai with a specific purpose: understand exactly how they implemented it. I ended up building my own version for [pi](https://github.com/badlogic/pi), the terminal-based coding agent.
...
*   **[pi](https://github.com/badlogic/pi)** (Mario Zechner) - the extensible coding agent that gave us the hooks to build on
