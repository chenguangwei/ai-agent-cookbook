...
locale: "en"
description: "Improving AI Skills with autoresearch & evals-skills"
category: "LLM Models"
tags: ["RAG"]
techStack: []
difficulty: "Beginner"
...
## Take two, I wired in @HamelHusain's [eval skills](https://github.com/hamelsmu/evals-skills) for input generation.


Hamel has done substantial work on the [evals problem](https://maven.com/parlance-labs/evals) with @sh_reya.

> Quoted tweet
> So many people talking about AI evals. @HamelHusain and @sh_reya show me how to actually build one. Live. Hamel and Shreya teach the world’s most popular course on evals, and have long been at the forefront of this emerging and important new skill for AI product builders. I'm ...
