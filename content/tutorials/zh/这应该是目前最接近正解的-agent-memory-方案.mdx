---
title: "这应该是目前最接近正解的 Agent 记忆方案"
slug: "这应该是目前最接近正解的-agent-memory-方案"
locale: "zh"
description: "这应该是目前最接近正解的 Agent 记忆方案"
category: "LLM Models"
tags: ["Claude", "RAG", "Prompt Engineering"]
techStack: []
difficulty: "Beginner"
duration: ""
thumbnail: "https://pbs.twimg.com/media/HJibZGPboAAGIZY.jpg"
featured: false
date: 2026-06-04
...
![](https://pbs.twimg.com/media/HJib4obagAABbWd.jpg)

两条线：内置 memory 存在本地 JSON 文件里，是我主动告诉它的东西：名字、角色、偏好、写作规则。MemOS 是另一套独立的长期记忆系统，从对话中自动提取 trace（事件轨迹）、policy（行为规则）、world_model（环境知识），然后把成熟的流程结晶成可调用的 skill。
...
![](https://pbs.twimg.com/media/HJict5rbcAALuBI.jpg)
...
![](https://pbs.twimg.com/media/HJic493akAAGw4g.jpg)

然后退出，开一个新 session，让它给另一个产品 MoleUninstaller 做介绍页，只给了产品名和功能描述，不给任何风格指示。

![](https://pbs.twimg.com/media/HJidG8-akAEaqy6.jpg)
...
![](https://pbs.twimg.com/media/HJidd-ObkAE-iEV.jpg)

从最初的全零，到现在 47 条记忆、8 个任务、24 条经验（12 条已启用）、2 个技能、1 条环境认知。全部自动生成。

经验页里最有意思的几条：

![](https://pbs.twimg.com/media/HJidru6awAEk17u.jpg)
...
![](https://pbs.twimg.com/media/HJidxQubUAAOo39.jpg)

check_obsidian_vault_path_env 从 V1 升级到了 V2，support 从 1 变成 2。MemOS 在第二次遇到类似任务时，自动升级了技能版本。这就是 Reflect2Evolve 里"Evolve"的意思：技能不是一成不变的，用得越多越成熟。
...
![](https://pbs.twimg.com/media/HJieAMKbYAAVgCR.jpg)
...
MemOS Local Plugin 官网：[https://memos-claw.openmem.net/](https://memos-claw.openmem.net/)GitHub：[https://github.com/MemTensor/MemOS/tree/main/apps/memos-local-plugin](https://github.com/MemTensor/MemOS/tree/main/apps/memos-local-plugin)
