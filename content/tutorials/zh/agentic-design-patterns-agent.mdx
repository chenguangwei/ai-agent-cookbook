---
title: "Agentic Design Patterns：一本让我重新理解\"Agent 到底是什么\"的书"
slug: "A-book-that-helps-me-rethink-what-an-Agent-truly-is"
locale: "zh"
description: "Agentic Design Patterns：一本让我重新理解\"Agent 到底是什么\"的书"
category: "Frameworks"
tags: ["LangChain", "OpenAI", "Claude", "RAG", "Multi-Agent", "Reflection", "Python", "CrewAI"]
techStack: []
difficulty: "Beginner"
duration: ""
thumbnail: "https://pbs.twimg.com/media/HJFsJNLbkAAuNuw.jpg"
featured: false
date: 2026-05-25
...
![](https://pbs.twimg.com/media/HJFvrmWasAAukQa.jpg)
...
![](https://pbs.twimg.com/media/HJFxJJ-awAAA6G0.jpg)
...
书里给了一个完整的代码示例。Producer 的 prompt 是"你是一个 Python 开发者，写一个计算阶乘的函数，处理边界条件和异常"。Critic 的 prompt 是"你是一个吹毛求疵的高级工程师，逐行审查代码，检查 Bug、风格、遗漏的边界条件、可改进的地方。如果完美就输出 CODE_IS_PERFECT，否则列出所有问题"。然后是一个 for 循环：Producer 写代码 → Critic 审 → Producer 根据意见改 → Critic 再审 → 直到 Critic 说 CODE_IS_PERFECT 或者达到最大迭代次数。
...
![](https://pbs.twimg.com/media/HJFxDFRaUAAfmRL.jpg)
...
![](https://pbs.twimg.com/media/HJFwZ9rawAAZjsZ.jpg)
...
![](https://pbs.twimg.com/media/HJFx4NWbwAA4214.jpg)
...
![](https://pbs.twimg.com/media/HJFwzoYbcAAulEY.jpg)
